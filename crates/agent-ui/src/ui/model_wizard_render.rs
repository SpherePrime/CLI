 ...
 use super::model_wizard::{ModelWizardScreen, WizardField, provider_name};
 
 pub fn render_screen(wizard: &ModelWizardScreen, frame: &mut ratatui::Frame, area: ratatui::layout::Rect) {
 ...
 fn render_form(wizard: &ModelWizardScreen, frame: &mut ratatui::Frame, area: ratatui::layout::Rect) {
     let fields = [
     ...
     for (i, (field, label)) in fields.iter().enumerate() {
         ...
         let block = Block::bordered().border_type(BorderType::Rounded).style(style);
 ...
 fn render_preview(wizard: &ModelWizardScreen, frame: &mut ratatui::Frame, area: ratatui::layout::Rect) {
