...
func TestPrimeInfo_MinimalConfig(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/prime/prime.json",
		"/project/.prime/prime.json",
	)
	output := buildPrimeInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/prime/prime.json")
	require.Contains(t, output, "/project/.prime/prime.json")
}

func TestPrimeInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildPrimeInfo(cfg, mgr, nil, nil, nil)
...
func TestPrimeInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_Options(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_TUIOptions(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_TUIOptionsUnpinnedCompletionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()
	...
	output := buildPrimeInfo(store, nil, nil, nil, nil)
...
func TestPrimeInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "prime-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("prime-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildPrimeInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "prime-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestPrimeInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "prime-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestPrimeInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestPrimeInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
