...
func enStrings() map[string]string {
	return map[string]string{
		...
		"cmd.agent_models":             "Agent Models",
		"cmd.pick_agent_model":         "Pick Agent Model",
		"cmd.pinned":                   "pinned",
...
func ruStrings() map[string]string {
	return map[string]string{
		...
		"cmd.agent_models":             "Модели агентов",
		"cmd.pick_agent_model":         "Модель агента",
		"cmd.pinned":                   "закреплена",
