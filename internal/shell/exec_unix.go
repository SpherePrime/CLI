...
// fully detached from Prime's controlling terminal. This prevents shells
...
// It also prevents child processes from sending signals to Prime's process
// group.
...
// from Prime's session and controlling terminal.
//
