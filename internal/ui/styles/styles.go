...
type Styles struct {
	...
	// Prime's background. Defining them here keeps output readable and
	...
	Header struct {
		...
		LogoGradCanvas    lipgloss.Style // Canvas for the compact "PRIME" gradient
		LogoGradFromColor color.Color    // "PRIME" wordmark gradient start
		LogoGradToColor   color.Color    // "PRIME" wordmark gradient end
	}
