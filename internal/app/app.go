...
import (
	...
	"github.com/charmbracelet/prime/internal/update"
...
type App struct {
	...
	// subscribers (notably `prime run` in client/server mode) can
...
// for `prime run`. A lossy fan-in here can drop the only terminal
