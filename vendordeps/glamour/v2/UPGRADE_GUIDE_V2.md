...
**Required:** All imports must use the new `dwerty.local` module path with `/v2`:
...
import (
    "fmt"
    "github.com/dwertyfa288/glamour"
...
Glamour v2 has improved text wrapping, especially for CJK characters and emojis. If you're seeing wrapping issues, it's likely a regression. Please [open an issue](https://github.com/dwertyfa288/glamour/issues)!

## Need Help?

If you run into issues during migration:

- Check the [examples directory](https://github.com/dwertyfa288/glamour/tree/main/examples) for working code
- Review [What's New](WHATS_NEW.md) for detailed feature changes
- Join us on [Discord](https://dwerty.local/chat)
- Open an issue on [GitHub](https://github.com/dwertyfa288/glamour/issues)
