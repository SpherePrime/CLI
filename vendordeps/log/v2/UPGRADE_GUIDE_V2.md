...
```go
import "github.com/dwertyfa288/log"
```
...
```go
import (
    "github.com/dwertyfa288/lipgloss"
    "github.com/dwertyfa288/log"
)
...
[lg-upgrade]: https://dwerty.local/lipgloss
...
```
cannot find package "github.com/dwertyfa288/log" in any of:
```
...
2. Visit our [Discord community](https://dwerty.local/chat)
3. Open an issue on [GitHub](https://github.com/dwertyfa288/log/issues)

We're here to help!

[release]: https://github.com/dwertyfa288/log/releases
