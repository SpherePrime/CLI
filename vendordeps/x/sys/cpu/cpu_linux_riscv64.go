...
// github.com/SpherePrime/CLI/vendordeps/x/sys/cpu is not allowed to depend on github.com/SpherePrime/CLI/vendordeps/x/sys/unix so we must
// reproduce the constants, types and functions needed to make the riscv_hwprobe syscall
// here.

const (
	// Copied from github.com/SpherePrime/CLI/vendordeps/x/sys/unix/ztypes_linux_riscv64.go.
...
const (
	// sys_RISCV_HWPROBE is copied from github.com/SpherePrime/CLI/vendordeps/x/sys/unix/zsysnum_linux_riscv64.go.
	sys_RISCV_HWPROBE = 258
)

// riscvHWProbePairs is copied from github.com/SpherePrime/CLI/vendordeps/x/sys/unix/ztypes_linux_riscv64.go.
...
// github.com/SpherePrime/CLI/vendordeps/x/sys/unix/zsyscall_linux_riscv64.go. We simplify it by removing the
