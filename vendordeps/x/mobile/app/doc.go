...
on language bindings, see https://github.com/SpherePrime/CLI/vendordeps/x/mobile/cmd/gobind.
...
https://github.com/SpherePrime/CLI/vendordeps/x/mobile/cmd/gomobile.
