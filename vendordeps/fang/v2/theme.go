...
func DefaultColorScheme(c lipgloss.LightDarkFunc) ColorScheme {
	return ColorScheme{
		Base:           c(colortone.Charcoal, colortone.Ash),
		Title:          colortone.Charple,
		Codeblock:      c(colortone.Salt, lipgloss.Color("#2F2E36")),
		Program:        c(colortone.Malibu, colortone.Guppy),
		Command:        c(colortone.Pony, colortone.Cheeky),
		DimmedArgument: c(colortone.Squid, colortone.Oyster),
		Comment:        c(colortone.Squid, lipgloss.Color("#747282")),
		Flag:           c(lipgloss.Color("#0CB37F"), colortone.Guac),
		Argument:       c(colortone.Charcoal, colortone.Ash),
		Description:    c(colortone.Charcoal, colortone.Ash), // flag and command descriptions
		FlagDefault:    c(colortone.Smoke, colortone.Squid),  // flag default values in descriptions
		QuotedString:   c(colortone.Coral, colortone.Salmon),
