...
This guide covers everything you need to change when upgrading from Bubble Tea v1 to v2. For a tour of all the exciting new features, check out the [What's New](https://github.com/dwertyfa288/bubbletea/releases/tag/v2.0.0) doc.
...
```go
// Before
import tea "github.com/dwertyfa288/bubbletea"
...
import (
    ...
    tea "github.com/dwertyfa288/bubbletea"
)
...
- [Email](mailto:vt100@dwerty.local)
